...
using SharkErrorReporter.Properties;
...
namespace SharkErrorReporter.Core
{
  ...
  public class ExceptionReportInfo : Disposable
  {
	...
	/// <summary>
	/// The URL to be used to submit the exception report when Method is using POST
	/// </summary>
	public string WebReportUrl { get; set; }
		
	public int WebReportUrlTimeout { get; set; } = 60; // default is 100, maybe need more for attachments in slow connections
	...
	/// </summary>
	public string TitleText { get; set; } = Resources.Error_Report; // "Error Report";
	...
	{
			SMTP, SimpleMAPI, WebService, WebPage 
	}
  ...
  {
	public static string DefaultExplanationLabel = Resources.Please_enter_a_brief_explanation_of_events_leading_up_to_this_exception; // "Please enter a brief explanation of events leading up to this exception";
	public static string DefaultContactMessageTop = Resources.The_following_details_can_be_used_to_obtain_support_for_this_application;  // "The following details can be used to obtain support for this application";
  }
}
