...
using System.Text;
using SharkErrorReporter.SystemInfo;
...
namespace SharkErrorReporter.Core
{
	...
	public class ExceptionReport
	{
		...
		/// <returns>
		/// A <see cref="T:System.String"/> that represents the current <see cref="T:SharkErrorReporter.Core.ExceptionReport"/>
		/// </returns>
		...
		/// <see cref="T:SharkErrorReporter.Core.ExceptionReport"/>; otherwise, <c>false</c>.</returns>
